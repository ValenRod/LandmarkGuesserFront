...
Project LandmarkGuesser is a simple copy of [GeoGuessr](https://www.geoguessr.com/) game. The rules are basically the same: players in this case are given an image of a landmark and their goal is to guess its location on the map. The closer a guess was, the more points they got. Game consists of 5 rounds.
